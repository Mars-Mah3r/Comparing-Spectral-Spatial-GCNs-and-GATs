...
class GraphSAGE(torch.nn.Module):
    ...
    def forward(self, x, edge_index):
        ...
        return x
model = GraphSAGE(hidden_channels=16, activation=F.relu, dropout_rate=0.5)
print(model)
        ...
        for dropout_rate in dropout_rates:
            for learning_rate in learning_rates:
                for weight_decay in weight_decays:
                    ...
                    model = GraphSAGE(hidden_channels=hidden_size, activation=activation, dropout_rate=dropout_rate)
...
# Model evalutaion 
model = GraphSAGE(hidden_channels=best_hyperparameters["hidden_size"], activation=best_hyperparameters["activation"], dropout_rate=best_hyperparameters["dropout_rate"])
